...
# -*- coding: utf-8 -*-
#
# ballet documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'ballet.tex',
     u'ballet Documentation',
